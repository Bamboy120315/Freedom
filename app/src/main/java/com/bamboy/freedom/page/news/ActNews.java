package com.bamboy.freedom.page.news;
...
import com.bamboy.freedom.freedom.manager.ManagerA;
import com.bamboy.freedom.page.news.bean.BeanNewsImg;
import com.bamboy.freedom.page.news.bean.BeanNewsText;
...
public class ActNews extends AppCompatActivity implements FreedomCallback {
    ...
    private void initData() {
        ...
        mList.add(new BeanNewsText("**公司继续停牌2个月: 混改谈判还在进行中", "5月10日晚间公告，公司正在积极推进本次重大事项的相关工作，但由于本次重大事项的具体实施方案涉及多个政府主管部门的事前审批程序，还存在不确定性……"));
        mList.add(new BeanNewsImg(R.drawable.picture_b, "这些水果狗狗不能吃，你知道吗？"));
        mList.add(new BeanNewsText("微软2017年Build大会: 无Win10更新 AI成压轴戏", "北京时间5月11日凌晨消息，微软2017年Build开发者大会于美国西雅图当地时间上午8点拉开帷幕。 此次大会不仅吸引了全球众多开发者前来交流……"));
        mList.add(new BeanNewsText("**公司继续停牌2个月: 混改谈判还在进行中", "5月10日晚间公告，公司正在积极推进本次重大事项的相关工作，但由于本次重大事项的具体实施方案涉及多个政府主管部门的事前审批程序，还存在不确定性……"));
        mList.add(new BeanNewsImg(R.drawable.picture_b, "这些水果狗狗不能吃，你知道吗？"));
